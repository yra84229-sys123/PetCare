...
const liveDb = firestore.getFirestore(app);
const liveAuth = auth.getAuth(app);
const liveStorage = storage.getStorage(app);
const liveFirestoreFns = firestore;
const liveAuthFns = auth;
const liveStorageFns = storage;
window.LiveFirestore = firestore;
window.LiveStorage = storage;

// Database Interface Object
const DB = {
  // Helper to ensure Firebase is ready (now resolves instantly as imports are static)
  async _ready() {
